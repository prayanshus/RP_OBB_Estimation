...
if __name__ == "__main__":
    ...
    if len(user_boxes) < 2:
        print("[System] Insufficient detections for triangulation. Exiting.")
        exit()

    # Filter outlier boxes before SAM2 — rejects detections whose centre is
    # more than 1× the box diagonal away from the consensus 3D projection.
